...
> 의견과 이름 제안을 [Issue #152](https://github.com/materialofair/ai-coding-session-reviewer/issues/152)에서 공유해주세요!
...
![AI Coding Session Reviewer Overview](assets/screenshots/app-overview.png)
...
| 플랫폼 | 다운로드 |
|----------|----------|
| macOS (Universal) | [`.dmg`](https://github.com/materialofair/ai-coding-session-reviewer/releases/latest) |
