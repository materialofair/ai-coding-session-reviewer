...
export const GroupHeader: React.FC<GroupHeaderProps> = ({
  ...
  return (
    ...
    >
      ...
      <span
        className={cn(
          "text-[13px] truncate flex-1 transition-colors duration-300",
      ...
      {/* Count Badge */}
      <span className={cn("flex items-center gap-1 text-[10px] font-mono px-1 py-0.5 rounded", colors.badge)}>
        {count}
      </span>
    </button>
  );
