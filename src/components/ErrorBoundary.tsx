    ...
    if (this.state.hasError) {
      const emailSubject = encodeURIComponent(
        t("error.emailTemplate.subject", {
          ...
          defaultValue: "[AI Coding Session Reviewer] Error Report: {{error}}",
        })
      );
...
${t("error.emailTemplate.description", {
  defaultValue:
    "I encountered the following error while using AI Coding Session Reviewer:",
})}
                  ...
                  <ul className="space-y-2 text-sm text-muted-foreground">
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      {t("error.troubleshootingSteps.updateVersion", {
                        defaultValue:
                          "Ensure you have the latest version of AI Coding Session Reviewer installed",
                      })}
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-muted-foreground/60">•</span>
