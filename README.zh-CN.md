...
> 请在 [Issue #152](https://github.com/materialofair/ai-coding-session-reviewer/issues/152) 分享您的想法和命名建议！
...
| 平台 | 下载 |
|----------|----------|
| macOS (通用) | [`.dmg`](https://github.com/materialofair/ai-coding-session-reviewer/releases/latest) |
